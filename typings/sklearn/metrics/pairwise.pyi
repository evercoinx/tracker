...
def check_pairwise_arrays(X, Y, *, precomputed=..., dtype=..., accept_sparse=..., force_all_finite=..., copy=...): # -> tuple[Unknown, Unknown]:
...
def check_paired_arrays(X, Y): # -> tuple[ndarray[Unknown, Unknown] | Unknown | NDArray[_ScalarType@astype] | NDArray[Any], ndarray[Unknown, Unknown] | Unknown | NDArray[_ScalarType@astype] | NDArray[Any]]:
...
def cosine_distances(X, Y=...): # -> Any | NDArray[signedinteger[_NBit1@__iadd__]] | NDArray[floating[_NBit1@__iadd__]]:
...
def paired_manhattan_distances(X, Y): # -> ndarray[Unknown, Unknown]:
    """Compute the L1 distances between the vectors in X and Y.
...
def linear_kernel(X, Y=..., dense_output=...): # -> ndarray[Any, dtype[bool_]] | ndarray[Any, dtype[floating[Any]]]:
    """
...
def rbf_kernel(X, Y=..., gamma=...): # -> NDArray[floating[_NBit1@__imul__]]:
    """
...
def laplacian_kernel(X, Y=..., gamma=...): # -> NDArray[floating[Any]] | Any:
...
def cosine_similarity(X, Y=..., dense_output=...): # -> Any | ndarray[Any, dtype[bool_]] | ndarray[Any, dtype[floating[Any]]]:
...
KERNEL_PARAMS = ...
@_deprecate_positional_args
def pairwise_kernels(X, Y=..., metric=..., *, filter_params=..., n_jobs=..., **kwds): # -> ndarray[Unknown, Unknown] | NDArray[_ScalarType@astype] | NDArray[Any] | NDArray[bool_] | None:
