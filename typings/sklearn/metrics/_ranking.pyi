...
def average_precision_score(y_true, y_score, *, average=..., pos_label=..., sample_weight=...): # -> Any | ndarray[Unknown, Unknown] | Literal[0]:
...
@_deprecate_positional_args
def precision_recall_curve(y_true, probas_pred, *, pos_label=..., sample_weight=...): # -> tuple[Any, Any, Any]:
