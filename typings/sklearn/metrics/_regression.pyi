...
@_deprecate_positional_args
def mean_squared_log_error(y_true, y_pred, *, sample_weight=..., multioutput=...): # -> Any:
...
@_deprecate_positional_args
def explained_variance_score(y_true, y_pred, *, sample_weight=..., multioutput=...): # -> ndarray[Unknown, Unknown]:
...
@_deprecate_positional_args
def r2_score(y_true, y_pred, *, sample_weight=..., multioutput=...): # -> float | ndarray[Unknown, Unknown]:
