...
class Bunch(dict):
    ...
    def __dir__(self): # -> dict_keys[Unknown, Unknown]:
        ...
...
def safe_sqr(X, *, copy=...): # -> ndarray[Unknown, Unknown] | NDArray[_ScalarType@astype] | NDArray[Any] | NDArray[signedinteger[Any]] | NDArray[floating[Any]] | NDArray[signedinteger[_NBit1@__ipow__]]:
