...
@_deprecate_positional_args
def check_cv(cv=..., y=..., *, classifier=...): # -> StratifiedKFold | KFold | _CVIterableWrapper | Literal[5]:
...
def train_test_split(*arrays, test_size=..., train_size=..., random_state=..., shuffle=..., stratify=...): # -> list[Unknown | ndarray[Unknown, Unknown] | list[Unknown]]:
