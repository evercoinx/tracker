...
"""
__all__ = ['GridSearchCV', 'ParameterGrid', 'fit_grid_point', 'ParameterSampler', 'RandomizedSearchCV']
class ParameterGrid:
    ...
    def __len__(self): # -> Any | Literal[1, 0]:
...
def fit_grid_point(X, y, estimator, parameters, train, test, scorer, verbose, error_score=..., **fit_params): # -> tuple[Unknown, Unknown, Unknown]:
