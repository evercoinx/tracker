...
class TruncatedSVD(TransformerMixin, BaseEstimator):
    ...
    def fit_transform(self, X, y=...): # -> ndarray[Any, dtype[bool_]] | ndarray[Any, dtype[floating[Any]]]:
    ...
    def transform(self, X): # -> ndarray[Any, dtype[bool_]] | ndarray[Any, dtype[floating[Any]]]:
