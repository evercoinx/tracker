...
class _ValidationScoreCallback:
    ...
    def __call__(self, coef, intercept): # -> Any:
        ...
...
class BaseSGD(SparseCoefMixin, BaseEstimator, metaclass=ABCMeta):
    ...
    def set_params(self, **kwargs): # -> Self@BaseSGD:
...
class SGDClassifier(BaseSGDClassifier):
    ...
    @property
    def predict_proba(self): # -> (X: Unknown) -> (ndarray[Unknown, Unknown] | Unknown | Any):
    ...
    @property
    def predict_log_proba(self): # -> (X: Unknown) -> NDArray[Any]:
