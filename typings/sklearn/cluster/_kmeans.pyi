...
def k_means(X, n_clusters, *, sample_weight=..., init=..., precompute_distances=..., n_init=..., max_iter=..., verbose=..., tol=..., random_state=..., copy_x=..., n_jobs=..., algorithm=..., return_n_iter=...): # -> tuple[Unknown, Unknown, None, Unknown] | tuple[Unknown, Unknown, None]:
...
class KMeans(TransformerMixin, ClusterMixin, BaseEstimator):
    ...
    def fit_transform(self, X, y=..., sample_weight=...): # -> ndarray[Unknown, Unknown] | NDArray[Any]:
    ...
    def predict(self, X, sample_weight=...): # -> ndarray[Unknown, Unknown]:
