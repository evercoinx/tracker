...
def unary_unary_rpc_method_handler(behavior, request_deserializer=..., response_serializer=...):
...
def unary_stream_rpc_method_handler(behavior, request_deserializer=..., response_serializer=...):
...
def stream_unary_rpc_method_handler(behavior, request_deserializer=..., response_serializer=...):
...
def stream_stream_rpc_method_handler(behavior, request_deserializer=..., response_serializer=...):
...
def xds_channel_credentials(fallback_credentials=...):
...
def metadata_call_credentials(metadata_plugin, name=...):
...
def ssl_server_credentials(private_key_certificate_chain_pairs, root_certificates=..., require_client_auth=...):
...
def ssl_server_certificate_configuration(private_key_certificate_chain_pairs, root_certificates=...):
...
def insecure_channel(target, options=..., compression=...):
...
def secure_channel(target, credentials, options=..., compression=...):
...
def server(thread_pool, handlers=..., interceptors=..., options=..., maximum_concurrent_rpcs=..., compression=..., xds=...):
