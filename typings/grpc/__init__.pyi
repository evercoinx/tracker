...
import sys
import six
from grpc import _compression, aio
...
def unary_unary_rpc_method_handler(behavior, request_deserializer=..., response_serializer=...): # -> Self@_RpcMethodHandler:
...
def unary_stream_rpc_method_handler(behavior, request_deserializer=..., response_serializer=...): # -> Self@_RpcMethodHandler:
...
def stream_unary_rpc_method_handler(behavior, request_deserializer=..., response_serializer=...): # -> Self@_RpcMethodHandler:
...
def stream_stream_rpc_method_handler(behavior, request_deserializer=..., response_serializer=...): # -> Self@_RpcMethodHandler:
...
def method_handlers_generic_handler(service, method_handlers): # -> DictionaryGenericHandler:
...
def ssl_channel_credentials(root_certificates=..., private_key=..., certificate_chain=...): # -> ChannelCredentials:
...
def xds_channel_credentials(fallback_credentials=...): # -> ChannelCredentials:
...
def metadata_call_credentials(metadata_plugin, name=...): # -> CallCredentials:
...
def access_token_call_credentials(access_token): # -> CallCredentials:
...
def composite_channel_credentials(channel_credentials, *call_credentials): # -> ChannelCredentials:
...
def ssl_server_credentials(private_key_certificate_chain_pairs, root_certificates=..., require_client_auth=...): # -> ServerCredentials:
...
def xds_server_credentials(fallback_credentials): # -> ServerCredentials:
...
def ssl_server_certificate_configuration(private_key_certificate_chain_pairs, root_certificates=...): # -> ServerCertificateConfiguration:
...
def dynamic_ssl_server_credentials(initial_certificate_configuration, certificate_configuration_fetcher, require_client_authentication=...): # -> ServerCredentials:
    """Creates a ServerCredentials for use with an SSL-enabled Server.
...
def local_channel_credentials(local_connect_type=...): # -> ChannelCredentials:
...
def local_server_credentials(local_connect_type=...): # -> ServerCredentials:
...
def alts_channel_credentials(service_accounts=...): # -> ChannelCredentials:
...
def compute_engine_channel_credentials(call_credentials): # -> ChannelCredentials:
...
def insecure_channel(target, options=..., compression=...): # -> Channel:
...
def secure_channel(target, credentials, options=..., compression=...): # -> Channel:
...
def server(thread_pool, handlers=..., interceptors=..., options=..., maximum_concurrent_rpcs=..., compression=..., xds=...): # -> _Server:
