...
def serialize(message, serializer): # -> None:
    ...

def deserialize(serialized_message, deserializer): # -> None:
    ...

def fully_qualified_method(group, method): # -> str:
    ...

def wait(wait_fn, wait_complete_fn, timeout=..., spin_cb=...): # -> bool:
