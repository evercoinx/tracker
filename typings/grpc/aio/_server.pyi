...
class Server(_base_server.Server):
    """Serves RPCs."""
    def __init__(self, thread_pool: Optional[Executor], generic_handlers: Optional[Sequence[grpc.GenericRpcHandler]], interceptors: Optional[Sequence[Any]], options: ChannelArgumentType, maximum_concurrent_rpcs: Optional[int], compression: Optional[grpc.Compression]) -> None:
        ...
...
def server(migration_thread_pool: Optional[Executor] = ..., handlers: Optional[Sequence[grpc.GenericRpcHandler]] = ..., interceptors: Optional[Sequence[Any]] = ..., options: Optional[ChannelArgumentType] = ..., maximum_concurrent_rpcs: Optional[int] = ..., compression: Optional[grpc.Compression] = ...): # -> Server:
