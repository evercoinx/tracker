...
def server(migration_thread_pool: Optional[Executor] = ..., handlers: Optional[Sequence[grpc.GenericRpcHandler]] = ..., interceptors: Optional[Sequence[Any]] = ..., options: Optional[ChannelArgumentType] = ..., maximum_concurrent_rpcs: Optional[int] = ..., compression: Optional[grpc.Compression] = ...):
