...
class Channel(_base_channel.Channel):
    ...
    async def __aenter__(self): # -> Self@Channel:
        ...
...
def insecure_channel(target: str, options: Optional[ChannelArgumentType] = ..., compression: Optional[grpc.Compression] = ..., interceptors: Optional[Sequence[ClientInterceptor]] = ...): # -> Channel:
...
def secure_channel(target: str, credentials: grpc.ChannelCredentials, options: Optional[ChannelArgumentType] = ..., compression: Optional[grpc.Compression] = ..., interceptors: Optional[Sequence[ClientInterceptor]] = ...): # -> Channel:
